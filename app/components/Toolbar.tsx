...
const Toolbar = () => {
  return (
    <nav className='w-full flex items-end justify-end'>
        <div  className="fixed xl:w-42 sm:w-[9.5rem] h-[3.2rem] bg-white flex text-[1.2rem] xl:gap-[1.2rem] sm:gap-[1.2rem]  items-center justify-center toolbar rounded-[7000px] sm:bottom-6 xl:bottom-10">
